#! /bin/sh
#SBATCH -o /gpfs/scratch/pn69ha/ge68wan2/logs/cov2/msglm_fit_cov2el_proteome_%J.log
#SBATCH -J ast_cov2_msglm_cov2el_proteome
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
ch-run $SCRATCH/docker4muc/archpc.msglm \
  ...
  -b $SCRATCH:/scratch \
  -- Rscript /projects/adhoc/$PROJECT_ID/msglm_fit_chunk_cov2el_proteome.R \
