#! /bin/sh
#SBATCH -J ast_cov2_hotnet_permtree
#SBATCH -o /gpfs/scratch/pn69ha/ge68wan2/logs/cov2/hotnet_permtrees_%J.log
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
srun -c1 -n1 --nodes=1 --ntasks-per-node=3 --mem-per-cpu=18GB --wait=0 \
     ...
     /projects/adhoc/$PROJECT_ID/hhotnet_perm_trees_chunk.jl \
