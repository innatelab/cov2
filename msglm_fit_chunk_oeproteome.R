...
#job.args <- c("cov2", "ast_cov2_msglm", "spectronaut_oeproteome_20200411", "20200411", "20200411", "0", "1235")
if (!exists('job.args')) {
...
background_contrasts.quantiles_rhs <- lapply(background_contrasts, function(contr) c(0.1, 0.9))
